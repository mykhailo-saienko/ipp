...
public class StreamHelper {
	...
	public static <T, R> R collect(Stream<T> it, Predicate<? super T> pred, Collector<T, ?, R> collector) {
		if (it == null) {
			return null;
		}
	...
	public static <T, R> R collect(Stream<T> it, Predicate<? super T> pred, Collector<T, ?, R> collector, int n) {
		if (it == null) {
			return null;
		}
	...
	public static <T> List<T> list(Stream<T> it, Predicate<? super T> pred) {
		return collect(it, pred, Collectors.toList());
	}

	public static <T> Set<T> set(Stream<T> it, Predicate<? super T> pred) {
