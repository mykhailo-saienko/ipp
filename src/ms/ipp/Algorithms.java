...
/**
 * A collection of routines that manipulate Java class related to functional programming, such as
 * Function, Predicate, Operator, Consumer, Supplier, etc.
 * 
...
public class Algorithms {
    ...
    /**
     * Creates a new {@code BiPredicate} which returns true if and only if at least one of the given
     * non-null {@code BiPredicates} returns true. Is equivalent to:
     * 
     * <pre>
     ...
     * @param preds a parameter array of {@link BiPredicate}s. Nulls in the array are ignored
     * @return null if all predicates are null or a concatenated BiPredicate otherwise.
     */
    @SafeVarargs
    ...
    /**
     * Creates a new {@code Predicate} which returns true if and only if at least one of the given
     * non-null {@code Predicates} returns true. Is equivalent to:
     * 
     * <pre>
     ...
     * 
     * @see #reduceNonNulls(BiFunction, Object...)
     * @param preds a parameter array of {@link Predicate}s. Nulls in the array are ignored
     * @return null if all predicates are null or a concatenated Predicate otherwise.
     */
    @SafeVarargs
    ...
    /**
     * Creates a new {@code BiConsumer} which calls all given {@code BiConsumer}s in the order of
     * their appearance as arguments. Is equivalent to:
     * 
     * <pre>
     ...
     * 
     * @see #reduceNonNulls(BiFunction, Object...)
     * @param procs a parameter array of {@link BiConsumers}s. Nulls in the array are ignored
     * @return null if all BiConsumers are null or a concatenated {@code BiConsumer} otherwise.
     */
    @SafeVarargs
    ...
    /**
     * Creates a new {@code Consumer} which calls all given {@code Consumer}s in the order of their
     * appearance as arguments. Is equivalent to:
     * 
     * <pre>
     ...
     * 
     * @see #reduceNonNulls(BiFunction, Object...)
     * @param procs a parameter array of {@link Consumers}s. Nulls in the array are ignored
     * @return null if all Consumers are null or a concatenated {@code Consumer} otherwise.
     */
    @SafeVarargs
    ...
    /**
     * Creates a new {@code Function} which returns the result of a given {@link Function} if a
     * given {@code Predicate} returns true and null otherwise
     * 
    ...
    /**
     * Creates a new {@code BiFunction} which returns the result of a given {@link BiFunction} if a
     * given {@code BiPredicate} returns true and null otherwise
     * 
     * @param pred a {@code BiPredicate} to use in the new {@code BiFunction}, not null
     * @param func a {@code BiFunction} to use in the new {@code BiFunction}, not null
     * @return
     */
    ...
    /**
     * If the {@code source} is not null and a given {@code Predicate} returns true for it, applies
     * a given {@code Function} to it and returns the result. Otherwise, returns null.
     * 
     * @param source the source value. Null returns null.
     * @param pred   the Predicate to test the value against. Null disables the test.
     * @param func   the Function to apply, not null.
     * @return
     */
    public static <T, U> U ignoreIfNullOrPred(T source,
    ...
    /**
     * Creates a new {@code BiConsumer} which calls a given {@code BiConsumer} only if a given
     * {@code BiPredicate} returns true.
     * 
     * @param pred a {@code BiPredicate} to use in the new {@code BiConsumer}. If null, the original
     *             {@code BiConsumer} is always called
     * @param proc a {@code BiConsumer} to use in the new {@code BiConsumer}. If null, the new
     *             {@code BiConsumer} only applies the given {@code BiPredicate}
     * @return null if both the {@code BiConsumer} and the {@code BiPredicate} are null or a new
     *         BiConsumer otherwise
     */
    ...
    /**
     * Creates a new {@code Consumer} which calls a given {@code Consumer} only if a given
     * {@code Predicate} returns true.
     * 
     * @param pred a {@code Predicate} to use in the new {@code Consumer}. If null, the original
     *             {@code Consumer} is always called
     * @param proc a {@code Consumer} to use in the new {@code Consumer}. If null, the new
     *             {@code Consumer} only applies the given {@code Predicate}
     * @return null if both the {@code Consumer} and the {@code Predicate} are null or a new
     *         Consumer otherwise
     */
    ...
    /**
     * Creates a {@code BiConsumer} by calling a given {@code Consumer} on the output of a given
     * {@code BiFunction}.
     * 
    ...
    /**
     * Creates a {@code Consumer<T>} out of a {@code Consumer<U>} by applying a given
     * {@code Function<T,U>} first.
     * 
    ...
    /**
     * Creates a {@code Consumer<R>} out of a {@code BiConsumer<T, U>} by applying given two
     * converters to the input first.
     * 
     * @param func1 the converter which produces the first argument in {@code proc}, not null
     * @param func2 the converter which produces the second argument in {@code proc}, not null
     * @param proc  the action, not null
     * @return
     */
    public static <T, U, R> Consumer<R> concatC(Function<? super R, T> func1,
                                                Function<? super R, U> func2,
                                                BiConsumer<? super T, ? super U> proc) {
        return r -> proc.accept(func1.apply(r), func2.apply(r));
    }

    /**
     * Creates a {@code Function<R, V>} out of a {@code BiFunction<T, U, V>} by applying given two
     * converters to the input first.
     * 
     * @param func1 the converter which produces the first argument in {@code func}, not null
     * @param func2 the converter which produces the second argument in {@code func}, not null
     * @param func  the BiFunction, not null
     * @return
     */
    public static <T, U, V, R> Function<R, V> concatF(Function<? super R, T> mod1,
                                                      Function<? super R, U> mod2,
                                                      BiFunction<? super T, ? super U, V> func) {
        return r -> func.apply(mod1.apply(r), mod2.apply(r));
    }

    /**
     * Creates a {@code Function<T, V>} by concatenating a {@code Function<T, U>} and a
     * {@code Function<U, V>}.
     * 
    ...
    /**
     * Creates a {@code Function} which calls a given {@code Consumer} prior to apply a given
     * {@code Function}.
     * 
    ...
    /**
     * Creates a {@code BiFunction} which calls a given {@code BiConsumer} prior to applying a given
     * {@code BiFunction}.
     * 
    ...
    ///////////////////////////////////////////////////////
    /**
     * Creates a {@code Supplier} which converts a given {@code Supplier}'s value by applying a
     * given {@code Function} to it. If the return value is null, the conversion function is
     * ignored.
     * 
    ...
    /**
     * Creates a {@code Supplier} which calls a given {@code Runnable} prior to calling a given
     * {@code Supplier}.
     * 
    ...
    ///////////////////////////////////////////////////////
    /**
     * Creates a {@code BiFunction} by applying a given {@code Function} to the second argument and
     * totally ignoring the first one.
     * 
    ...
    /**
     * Creates a {@code BiFunction} by applying a given {@code Function} to the first argument and
     * totally ignoring the second one.
     * 
     * @param func the Function to apply. Null returns null.
     * @return
     */
    ...
    /**
     * Creates a {@code BiConsumer} by applying a given {@code Consumer} to the second argument and
     * totally ignoring the first one.
     * 
    ...
    /**
     * Creates a {@code BiConsumer} by applying a given {@code Consumer} to the first argument and
     * totally ignoring the second one.
     * 
     * @param proc the Function to apply. Null returns null.
     * @return
    ...
    /**
     * Creates a {@code BiPredicate} by applying a given {@code Predicate} to the second argument
     * and totally ignoring the first one.
     * 
    ...
    /**
     * Creates a {@code BiPredicate} by applying a given {@code Predicate} to the first argument and
     * totally ignoring the second one.
     * 
     * @param pred the Predicate to apply. Null returns null.
     * @return
    ...
    /**
     * Creates a {@code BinaryOperator} by applying a given {@code UnaryOperator} to the second
     * argument and totally ignoring the first one.
     * 
    ...
    /**
     * Creates a {@code BinaryOperator} by applying a given {@code UnaryOperator} to the first
     * argument and totally ignoring the second one.
     * 
     * @param op the UnaryOperator to apply. Null returns null.
     * @return
     */
    ...
    /**
     * Makes a {@code BiPredicate} out of a given {@code BiFunction} returning boolean.
     * 
    ...
    ///////////////////////////////////////////////////////
    /**
     * Creates a {@code Consumer} out of a given {@code Function} by just ignoring its return value
     * 
     * @param func the Function to convert. Null returns null
     * @return
     */
    ...
    /**
     * Creates a {@code BiConsumer} out of a given {@code BiFunction} by just ignoring its return
     * value
     * 
     * @param func the BiFunction to convert. Null returns null
     * @return
    ...
    /**
     * Makes a Function which returns a fixed value after calling a given {@code Consumer}.
     * 
    ...
    /**
     * Makes a BiFunction which returns a fixed value after calling a given {@code BiConsumer}.
     * 
    ...
    /**
     * Returns a constant {@code Supplier}, i.e., a Supplier which always returns a given value.
     * 
     * @param value the value to return, may be null
     * @return
     */
    ...
    /**
     * Returns a constant {@code Function}, i.e., a Function which always returns a given value.
     * 
     * @param value the value to return, may be null
     * @return
     */
    ...
    /**
     * Returns a constant {@code BiFunction}, i.e., a Function which always returns a given value.
     * 
     * @param value the value to return, may be null
     * @return
     */
    ...
    ///////////////////////////////////////////////////////
    /**
     * Creates a {@code Consumer} accepting {@code Entry<T,U>} out of a given {@code BiConsumer}
     * accepting {@code T} and {@code U} as arguments.
     * 
    ...
    /**
     * Creates a {@code Function} accepting {@code Entry<T,U>} out of a given {@code BiFunction}
     * accepting {@code T} and {@code U} as arguments.
     * 
     * @param func the BiFunction to convert. Null returns null
     * @return
    ...
    /**
     * Creates a {@code Predicate} accepting {@code Entry<T,U>} out of a given {@code BiPredicate}
     * accepting {@code T} and {@code U} as arguments.
     * 
    ...
    /**
     * Creates a {@code Function} returning {@code Entry<T,U>} out of two {@code Function}s which
     * return {@code T} and {@code U}, respectively.
     * 
     * @param func1 the first Function, not null
     * @param func2 the second Function, not null
     * @return
    ...
    ///////////////////////////////////////////////////////
    /**
     * Reduces all non-null elements to a single element by means of a given accumulator. <br>
     ...
     * @return null if all elements are null or the first non-null element if it is the only one in
     *         the array. Otherwise, the result of the last call to {@code accumulator}.
     */
    ...
    /**
     * Reduces all non-null elements to a single element by means of a given initializator (to
     * initialize the result from the first element) and a given accumulator (to update the result).
     * <br>
     * Compare to {@link Stream#reduce(Object, BinaryOperator)}. The difference is that the
     * Stream-version needs an explicit identity element provided and poses additional constraint on
     * this element (in order to parallelize correctly). We perform the reduction sequentially and
     * can generate the identity in place.
     * 
     * @param initializer
     * @param accumulator
     * @param elems
     * @return
     */
    public static <T, U> U reduce(Function<T, U> initializer,
